    ...
    >
      <div className="sidebar-list px-3 pt-3 d-flex flex-column justify-content-between">
        <div className="sidebar-list__top d-flex flex-column gap-1 ">
          ...
          <button
            className="sidebar-list__item  border-0 bg-transparent "
            onClick={handleToggle}
          >
            <svg
              width="24"
...
function SubscriptionPlan({ dark, bgcolor }) {
  return (
    ...
    >
      ...
      <div
        className="canvas-list__bottom p-2"
        style={{ backgroundColor: bgcolor, marginTop: 32, marginInline: 18 }}
      >
        <div className="card__Box p-3" style={{ borderRadius: 8 }}>
          <div
            className="card__top  d-flex justify-content-between "
